...
public class MsgConsumerRebalanceListener implements ConsumerRebalanceListener {
    ...
    private ConcurrentHashMap<TopicPartition, Long> offsetsMap = new ConcurrentHashMap<>();
    ...
    public void onPartitionsAssigned(Collection<TopicPartition> partitions) {
        ...
        partitions.forEach(partition -> {
            ...
            if (offset == null) {
                ...
                consumer.seek(partition, offsetsMap.get(partition));
            }
        });
    }
}
