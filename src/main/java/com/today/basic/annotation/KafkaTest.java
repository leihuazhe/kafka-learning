...
public class KafkaTest {
    ...
    public void test1() {
        ...
        try {
            msgConsumerClass = clazz.getClassLoader().loadClass("com.today.basic.annotation.MsgConsumer");
            consumerListenerClass = clazz.getClassLoader().loadClass("com.today.basic.annotation.ConsumerListener");
