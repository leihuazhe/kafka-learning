...
public abstract class KafkaConfigBuilder {
    ...
    public static class ConsumerConfiguration extends KafkaConfigBuilder {
        ...
        public ConsumerConfiguration maxPollSize(int pollSize) {
            properties.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, pollSize);
            return this;
        }

        public ConsumerConfiguration maxPollInterval(String interval) {
            properties.put(ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, interval);
            return this;
        }
